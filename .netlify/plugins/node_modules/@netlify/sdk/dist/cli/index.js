...
export const generateBuildEventHandler = async (extension, config, opts) => {
    ...
    const { dependencies } = extensionPackageJson;
  ...
  `;
    ...
    const sdkPackageJsonPath = resolve(cwd, "node_modules/@netlify/sdk/package.json");
    const sdkPackageJson = await readJSON(sdkPackageJsonPath);
    const sdkVersionFromPackageJson = sdkPackageJson.version;
    const sdkVersion = sdkVersionFromPackageJson || getPackageVersion();
