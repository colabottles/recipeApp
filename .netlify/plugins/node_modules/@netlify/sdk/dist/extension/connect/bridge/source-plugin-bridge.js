...
export class SourcePluginBridgeAPI extends BridgePluginAPI {
    ...
    `);
        ...
        if (
        // janky temporary workaround
        // cloud-sourcerer still uses Gatsby so the authorization directive from content-engine isn't present but we need it to exist
        // and another connector instance hasn't already defined it
        !globalThis.___authorization_directive_added) {
            // then define the authorization directive
            globalThis.___authorization_directive_added = true;
            schemaCustomizationApi.store.dispatch({
                type: `CREATE_FIELD_EXTENSION`,
                payload: {
                    name: "authorization",
