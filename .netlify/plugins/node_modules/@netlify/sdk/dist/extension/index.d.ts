...
export declare class NetlifyExtension<SiteConfigSchema extends z.ZodSchema = z.ZodUnknown, TeamConfigSchema extends z.ZodSchema = z.ZodUnknown, BuildContext extends z.ZodSchema = z.ZodUnknown, BuildConfigSchema extends z.ZodSchema = z.ZodUnknown, ConnectorConfigSchema extends z.ZodSchema = z.ZodUnknown> {
     ...
     */
    addBuildEventContext(handler: BuildContextHandler<ConfigurationResponse<Zod.infer<SiteConfigSchema>>, ConfigurationResponse<Zod.infer<TeamConfigSchema>>, Zod.infer<BuildContext>, Zod.infer<ConnectorConfigSchema>>): void;
    /**
     * Used to add an endpoint to the extension.
     */
    addEndpoint(name: string, handler: FunctionHandler<NetlifySDKContext<Zod.infer<SiteConfigSchema>, Zod.infer<TeamConfigSchema>>>): void;
    /**
     ...
     */
    onInstall(handler: FunctionHandler<NetlifySDKContext<Zod.infer<SiteConfigSchema>, Zod.infer<TeamConfigSchema>>>): void;
    /**
     * The handler to use for the onUninstall endpoint.
     */
    onUninstall(handler: FunctionHandler<NetlifySDKContext<Zod.infer<SiteConfigSchema>, Zod.infer<TeamConfigSchema>>>): void;
    /**
...
export declare class NetlifyIntegration<_SiteConfigSchema extends z.ZodSchema = z.ZodUnknown, _TeamConfigSchema extends z.ZodSchema = z.ZodUnknown, _BuildContext extends z.ZodSchema = z.ZodUnknown, _BuildConfigSchema extends z.ZodSchema = z.ZodUnknown, _ConnectorConfigSchema extends z.ZodSchema = z.ZodUnknown> {
    ...
    addBuildEventHandler(_type: BuildHookType, _func: BuildHookWithContext<Zod.infer<_BuildContext>, Zod.infer<_BuildConfigSchema>>, _options?: BuildHookOptions): void;
    addBuildEventContext(_handler: BuildContextHandler<Zod.infer<_SiteConfigSchema>, Zod.infer<_TeamConfigSchema>, Zod.infer<_BuildContext>, Zod.infer<_ConnectorConfigSchema>>): void;
    addEndpoint(_name: string, _handler: FunctionHandler<NetlifySDKContext<Zod.infer<_SiteConfigSchema>, Zod.infer<_TeamConfigSchema>>>): void;
    addWrapper(_name: string, _handler: IntegrationHandler): void;
    onInstall(_handler: FunctionHandler<NetlifySDKContext<Zod.infer<_SiteConfigSchema>, Zod.infer<_TeamConfigSchema>>>): void;
    onUninstall(_handler: FunctionHandler<NetlifySDKContext<Zod.infer<_SiteConfigSchema>, Zod.infer<_TeamConfigSchema>>>): void;
    onDisconnect(_handler: FunctionHandler<NetlifySDKContext<Zod.infer<_SiteConfigSchema>, Zod.infer<_TeamConfigSchema>>>): void;
    addWebhookHandler(_name: string, _handler: FunctionHandler<NetlifySDKContext<Zod.infer<_SiteConfigSchema>, Zod.infer<_TeamConfigSchema>>>): void;
