...
export class NetlifyExtensionClient extends NetlifyClient {
     ...
     */
    createVisualEditorConfiguration = async ({ teamId, siteId, config, name, projectId, prefix, }) => {
        return this.extensionApi
            .url(`/team/${teamId}/integrations/${this.extension}/configuration/create/${siteId}?project_id=${projectId}`)
     ...
     */
    updateVisualEditorConfiguration = async ({ teamId, siteId, configurationId, config, name, projectId, prefix, }) => {
        return this.extensionApi
